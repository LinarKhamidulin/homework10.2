...
def test_transaction_descriptions(test_transactions: list):
...
def test_card_number_generator(my_code_start: int, my_code_end: int):
    generator = card_number_generator(my_code_start, my_code_end)
